...
const siteData = {
  business: {
    name: "SAJC Pest Control and Fumigation",
    legalName: "SAJC Pest Control and Fumigation",
    tagline: "Professional Cleaning & Pest Control Solutions",
    description: "SAJC Pest Control and Fumigation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
    phone: "+263 78 209 2041",
    phoneRaw: "+263782092041",
    whatsappNumber: "263782092041",
    email: "info@sajcpestcontrolandfu.co.zw",
    address: "1316 Waxberry, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 4.8,
    ratingRounded: 5,
    ...
    cookieConsentKey: "sajc-pest-control-and-fumigation-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "SAJC", logoLine2: "Pest Control" },
  ...
  homeTestimonials: [
    { text: "SAJC Pest Control and Fumigation transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "We had a serious cockroach problem. SAJC Pest Control and Fumigation came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Professional, punctual, and incredibly thorough. SAJC Pest Control and Fumigation handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "SAJC Pest Control and Fumigation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
  ...
  reviews: {
    ...
    items: [
      { text: "SAJC Pest Control and Fumigation transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5 },
      { text: "We had a serious cockroach problem. SAJC Pest Control and Fumigation came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "Professional, punctual, and incredibly thorough. SAJC Pest Control and Fumigation handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. SAJC Pest Control and Fumigation exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend SAJC Pest Control and Fumigation to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at SAJC Pest Control and Fumigation is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. SAJC Pest Control and Fumigation has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi SAJC Pest Control and Fumigation! I would like to request a quote.",
    backgroundImage: "https://images.unsplash.com/photo-1584813539890-30373c796e72?w=1920&q=85",
  },

  footer: {
    description: "SAJC Pest Control and Fumigation was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses a",
    bottomLinks: [
